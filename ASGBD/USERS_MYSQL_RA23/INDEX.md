...
No se puede conectar con dicho usuario, al tratarse de un usuario que pertenece a un dominio, al que no estamos conectados.
...
Si, puesto que es un cambio en la tabla de usuarios, el sistema no actualiza la contraseña.

### 22 ¿Puedo utilizar la función PASSWORD con GRANT? Justifica tu respuesta.
MySQL maneja automáticamente el cifrado de contraseñas en CREATE USER o ALTER USER.
PASSWORD() está obsoleta y puede causar errores de autenticación
